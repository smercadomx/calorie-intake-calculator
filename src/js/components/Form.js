        ...
        return (
            <form id="form" action="calculate" method="post" onSubmit={this.handleOnSubmit}>
                ...
                <fieldset className="field">
                    ...
                    <input id="sex-male" type="radio" name="sex" value="male" onChange={handleInputChange} checked={'male' === data.sex} required />
                    <label htmlFor="sex-male">Male</label>
                    <input id="sex-female" type="radio" name="sex" value="female" onChange={handleInputChange} checked={'female' === data.sex} required />
